  ...
  <section className={styles.section__team}>
      ...
      <div className={styles.team__wrapper}>
        <div className={styles.member}>
          ...
          <p className={styles.member__descr}> Разработала игру «Оазис», 
          в которой необходимо ввести пропущенное в предложении слово. 
          Придала 3/4 игр внешний вид, сверстала словарь и учебник, 
          сделала их настройки, а еще графики, компоненты для отображения статистики, 
          а также страницу авторизации. </p>
        </div>
        <div className={styles.member}>

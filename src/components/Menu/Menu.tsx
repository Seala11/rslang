    ...
    <div className={styles.menu__wrapper}>
      <NavLink to='/textbook'>
        <div className={styles.menu__card}>
          ...
          <p className={styles.card__descr}>
            Коллекция содержит 3600 часто употребляемых английских слов. Возможность выбрать
            подходящий уровень
          </p>
        </div>
      </NavLink>
      ...
      <NavLink to='/statistics'>
        <div className={styles.menu__card}>
          ...
          <p className={styles.card__descr}>
            На странице статистики отображается краткосрочная статистика по мини-играм и по словам
